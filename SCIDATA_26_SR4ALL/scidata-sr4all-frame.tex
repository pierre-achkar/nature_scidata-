...
\input{scidata--sr4all-pre}     % title, authors, abstract

\input{scidata--sr4all-part1}   % Background and Summary
\input{scidata--sr4all-part2}   % Methods
\input{scidata--sr4all-part3}   % Data Records
\input{scidata--sr4all-part4}   % Technical Validation
\input{scidata--sr4all-part5}   % Usage Notes (optional)
\input{scidata--sr4all-part6}   % Data Availability + Code Availability
\input{scidata--sr4all-part7}   % Author Contributions / Competing Interests / Funding / Acknowledgements
