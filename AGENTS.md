...
Read this file first at the start of every task in this repository.
...
2. `SR4ALL_scientific_data_notes.md`
3. `scientific_data_submission_guidelines.md`
...
- The main active target is the `SCIDATA_26_SR4ALL` resubmission to *Nature Scientific Data*.
...
- Re-read `PROJECT_ORIENTATION.md`.
- Identify the active target folder.
- State the assumption you are making and proceed conservatively.
