...
\input{sdata23-scientific-text-reuse-corpus-pre}
\input{sdata23-scientific-text-reuse-corpus-part1}
\input{sdata23-scientific-text-reuse-corpus-part2}
\input{sdata23-scientific-text-reuse-corpus-part3}
\input{sdata23-scientific-text-reuse-corpus-part4}
\input{sdata23-scientific-text-reuse-corpus-part5}
\input{sdata23-scientific-text-reuse-corpus-part6}

%\bibliography{scidata22-scientific-text-reuse-corpus-lit}
\input{sdata23-scientific-text-reuse-corpus-lit}
...
\hbox to \textwidth{
  \hfill
  \includegraphics[width=.4\textwidth]{fig-lengths}
  \qquad
  \includegraphics[width=.4\textwidth]{fig-positions}
  \hfill
}
\caption{Left side: cumulative ratio of reuse cases by normalized case length. Right side: cumulative ratio of reuse cases by normalized position.}
\label{fig:distributions}
\end{figure}

\input{table-data-record-cases}
\input{table-data-record-publications}
%\input{table-pan13}
%\input{table-pan13-individual}
%\input{table-pan13-f1}
%\input{table-pan13-f1-single}
\input{table-pan13-f05-single}
%\input{table-pan13-large}
\input{table-pan13-evaluation}
\input{table-discipline-distribution}
\input{table-example-cases}
\end{document}
