# ISSUE-08: Plan scalable validation support

## What to do

- Add a scalable complement to manual validation where useful.
...
- The paper does not overclaim what automated judging proves.
