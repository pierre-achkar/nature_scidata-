# ISSUE-10: Write failure modes and uncertainty discussion
...
- `Technical Validation` contains an explicit failure-mode discussion.
- Uncertainty is named rather than implied.
- Reviewers can see what the data quality claims do and do not cover.
